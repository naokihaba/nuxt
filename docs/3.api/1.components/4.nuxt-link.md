  ...
  experimental: {
    defaults: {
      nuxtLink: {
        ...
        externalTargetAttribute: undefined,
...
interface NuxtLinkOptions {
  ...
  externalTargetAttribute?: '_blank' | '_parent' | '_self' | '_top' | (string & {}) | null
  activeClass?: string;
...
- `externalTargetAttribute`: A default `target` attribute value applied on external links.
